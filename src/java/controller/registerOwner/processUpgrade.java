...
import static DAO.RegisterOwnerDAO.getRequestById;
...
public class processUpgrade extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("Approve".equals(action)) {
                RegisterOwnerDAO.updateRequestStatus(requestId, 1);
                    HostUpgradeRequest request2 = getRequestById(requestId);
//                HostUpgradeRequest upgradeRequest = RegisterOwnerDAO.getRequestById(requestId);
                Account user = AccountDAO.getAccountById(request2.getAccountId());
                //update role to host
//                int accountID1 = request2.getAccountId();
                AccountDAO.updateUserRole(request2.getAccountId(), "2");
                //send mail to notice 
        ...
        response.sendRedirect("./admin/pendingRequests.jsp");// tự sửa phần ni nhé 
    }
