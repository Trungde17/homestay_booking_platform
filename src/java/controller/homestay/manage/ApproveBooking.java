...
public class ApproveBooking extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HomestaySummaryDTO ht = (HomestaySummaryDTO) session.getAttribute("homestay_summary");
        ...
        try {
            ...
            ArrayList<Booking> bookings = BookingDAO.getAllUnapprovedBookingsOfHomestay(ht.getHomestay_id());
