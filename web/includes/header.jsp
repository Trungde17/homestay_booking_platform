            ...
            <ul class="navbar-nav ms-auto">
                ...
                <c:if test="${account!=null}">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="homestayDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            My Homestay
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="homestayDropdown">
                            ...
                            <c:forEach var="ht_summary" items="${homestaySummarys}">
                                <li><a class="dropdown-item homestay-item" href="#" 
                                       onclick="postToManageHomestay(${ht_summary.getHomestay_id()})"><i class='homestay-icon bx bx-home-smile'></i>${ht_summary.getHomestay_name()}
                                    </a></li>
                                </c:forEach>
...
<script>
    function postToManageHomestay(homestayId) {
        ...
        form.method = 'POST';
        form.action = `${window.location.origin}${pageContext.request.contextPath}/homestay/homestay_manage/layout.jsp`;
