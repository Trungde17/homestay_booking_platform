...
<!--                        <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="./customer.jsp">Show All</a>
                        </div>
                            ...
                            <table id="customer-table" class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        // Get accounts for role 1 (Normal Customer)
                                        List<Account> customers = AccountDAO.getAccountsByRole(3);
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Onwer List</h6>
                            <a href="./owner.jsp">Show All</a>
                        </div>
                        <div class="table-responsive">
                            <table id="owner-table" class="table text-start align-middle table-bordered table-hover mb-0">
                                <thead>
                                    <tr class="text-dark">
                                        <th scope="col">Email</th>
                                        <th scope="col">First Name</th>
                                ...
                                <tbody>
                                    <%
                                        // Get accounts for role 2 (Homestay Owner)
