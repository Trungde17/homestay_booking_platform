<%-- 
    ...
    Created on : May 24, 2024, 1:00:59 AM
    Author     : ASUS
--%>
...
<body>
    ...
    <div class="container bootstrap snippet">
        <div class="row">
            <div class="col-sm-10"><h1>Hello , ${sessionScope.account.first_name}</h1></div>
            <div class="col-sm-2"><a href="home" class="pull-right"><img title="logo" class="img-circle img-responsive" src="img/project_logo.png"></a></div>
        </div>
        <div class="row">
            ...
            <div class="col-sm-9">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#">Change Password</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        <hr>
                        <form class="form" action="${pageContext.request.contextPath}/changePassword
                        " method="post" id="registrationForm">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <label style="color: green"> ${ms1}</label>
                                </div>
                            </div>
                        </form>
                        <hr>
